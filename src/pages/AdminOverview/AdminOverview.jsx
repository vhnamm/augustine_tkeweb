...
import { faBox, faDollarSign, faFaceSmile, faMoneyBill } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div>
        ...
        <div className={clsx("grid", styles.content)}>
          <ul className={clsx("row")}>
            <li className={clsx("col lg-3", styles.summary_item)}>
              <div className={clsx(styles.item_wrap, styles.cashPerOrder_block)}>
                ...
                <svg viewBox="0 0 100 40" className={styles.line}>
                  <path d="M0 30 C 20 10, 40 35, 60 15 S 80 5, 100 20" 
                        fill="none" 
                        stroke="#3e7cef" 
                        stroke-width="2" />
                </svg>
            ...
            <li className={clsx("col lg-3", styles.summary_item)}>
              <div className={clsx(styles.item_wrap, styles.totalOrder_block)}>
                ...
                <svg viewBox="0 0 100 40" className={styles.line}>
                  <path d="M0 20 C 20 10, 40 35, 60 15 S 80 5, 100 10" 
                        fill="none" 
                        stroke="#fe9865" 
                        stroke-width="2" />
                </svg>
            ...
            <li className={clsx("col lg-3", styles.summary_item)}>
              <div className={styles.item_wrap}>
                ...
                <svg viewBox="0 0 100 40" className={styles.line}>
                  <path d="M0 30 C 20 10, 40 35, 60 15 S 80 5, 100 0" 
                        fill="none" 
                        stroke="#373737" 
                        stroke-width="2" />
                </svg>
          ...
          <div className={clsx("row")}>
            <div className={clsx("col lg-7")}>
              <h4 style={{color: "#fff", margin: "20px 0 12px 0", fontSize: "14px"}}>Sale Statistic</h4>
                ...
                <ul className={styles.product_list}>
                  <li className={styles.product_item}>
                    <div className={styles.prod_info_wrap}>
                      ...
                      <span className={styles.prod_name}>Áo thun nam cotton premium</span>
                    </div>
                  ...
                  <li className={styles.product_item}>
                    ...
                    <div className={styles.prod_info_wrap}>
                      <div className={styles.prod_img}></div>
                      <span className={styles.prod_name}>Ao thun in Augustine </span>
                    </div>
                  ...
                  <li className={styles.product_item}>
                    <div className={styles.prod_info_wrap}>
                      <div className={styles.prod_img}></div>
                      <span className={styles.prod_name}>Ao thun form slim fit</span>
                    </div>
                    <span>567 orders</span>
                  </li>
                  <li className={styles.product_item}>
                    <div className={styles.prod_info_wrap}>
                      <div className={styles.prod_img}></div>
                      <span className={styles.prod_name}>Áo thun in hình .Boxy</span>
                    </div>
                    <span>567 orders</span>
                  </li>
                </ul>
        ...
        <div className={styles.newOrder_wrap}>
          <h4 style={{color: "#fff", fontSize: "13px", marginBottom: "13px"}}>Latest Orders</h4>
